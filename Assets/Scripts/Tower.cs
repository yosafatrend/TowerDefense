...
public class Tower : MonoBehaviour
{
    ...
    //Digunakan untuk menyimpan posisi yang akan ditempati selama tower didrag
    ...
    //Mengubah order in layer pada tower yg sedang didrag
    ...
    public void ShootTarget()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs(_towerHead.transform.rotation.eulerAngles.z -
    ...
    public void SeekTarget()
    {
        ...
        _towerHead.transform.rotation = Quaternion.Euler(new Vector3(0f, 0f, targetAngle - 90f));
